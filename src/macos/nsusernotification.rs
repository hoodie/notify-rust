...
///
/// This stack is deprecated. Prefer enabling the `preview_macos_un`
...
impl NotificationHandle {
    ...
    /// and will be removed in 5.0. Prefer the `preview_macos_un`
    /// feature for proper response handling.
    #[deprecated(
        since = "4.1.0",
        note = "enable the preview_macos_un feature for proper response handling; the legacy NSUserNotificationCenter path will be removed in 5.0"
    )]
        ...
        F: FnOnce(&str),
    {
        ...
        match n.send().unwrap_or(LegacyResponse::None) {
            mac_notification_sys::Response::ActionButton(ref label) => invocation_closure(label),
            mac_notification_sys::Response::Click => invocation_closure("default"),
            mac_notification_sys::Response::Reply(ref text) => invocation_closure(text),
            mac_notification_sys::Response::CloseButton(_) | LegacyResponse::None => invocation_closure("__closed"),
        }
    }
}
